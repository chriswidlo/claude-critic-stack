...
| [`upgrades/README.md`](upgrades/README.md) | The lab — entry tiers, lifecycle, format. | Excellent at what it covers. | Not about the workflow. Mentioned only to clarify it is *not* the missing doc. |
