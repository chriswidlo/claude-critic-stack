...
- **A small set of operational primitives:** path-discipline rules (no absolute paths in artifacts), a `prompts/five-pressures.md` checklist, a `workflows/architecture-review.md` legacy pre-13-step workflow, a `tests/regression/` folder, and minimal `bin/` ingestion tooling.
